...
export const seoConfigs = {
  ...
  hotel: {
    ...
    titleEs: "The Local House Hotel | Hotel Boutique en Ocean Drive Miami Beach | Desde $199",
    descriptionEs: "Hotel boutique Art Deco en 400 Ocean Drive, South of Fifth Miami Beach. Habitaciones con vista al mar desde $199, piscina en la azotea, sillas de playa reservadas, famoso brunch. Propiedad italiana desde 2012. Reserva directo.",
    keywordsEs: "hotel boutique miami beach, hotel ocean drive, hotel south of fifth, hotel miami beach piscina azotea, hotel art deco miami beach, the local house hotel",
  ...
  brunch: {
    ...
    titleEs: "Mejor Brunch en Miami Beach | #1 Brunch en South Beach | The Local House",
    descriptionEs: "Votado mejor brunch en Miami Beach y South Beach. Famoso Lobster Eggs Benedict ($33), cócteles artesanales, vistas a Ocean Drive. Abierto 8AM-4PM todos los días. Reserva en OpenTable.",
