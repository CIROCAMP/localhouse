        ...
        <div className="container">
          ...
          <div className="mt-12 pt-10 border-t border-[#E5DED5]">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70 hover:opacity-100 transition-opacity">
              ...
              <a onClick={() => window.trackOpenTableClick?.()} href="https://www.opentable.com/the-local-house" target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 mt-10 pt-10 border-t border-[#E5DED5]">
            ...
            <a onClick={() => window.trackOpenTableClick?.()} href="https://www.opentable.com/the-local-house" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#666] hover:text-[#da3743] transition-colors">
